...
fn e2e_unicode_width_cjk() {
    ...
    crate::assert_with_log!(char_width(chinese) == 2, "chinese width", 2usize, char_width(chinese));
    crate::assert_with_log!(char_width(japanese) == 2, "japanese width", 2usize, char_width(japanese));
    crate::assert_with_log!(char_width(korean) == 2, "korean width", 2usize, char_width(korean));
...
fn e2e_unicode_width_combining() {
    ...
    crate::assert_with_log!(char_width(acute) == 0, "acute width", 0usize, char_width(acute));
    crate::assert_with_log!(char_width(tilde) == 0, "tilde width", 0usize, char_width(tilde));
    crate::assert_with_log!(char_width(circumflex) == 0, "circumflex width", 0usize, char_width(circumflex));
...
fn e2e_unicode_str_width_ascii() {
    ...
    crate::assert_with_log!(str_width("hello") == 5, "hello width", 5usize, str_width("hello"));
...
fn e2e_unicode_str_width_mixed() {
    ...
    crate::assert_with_log!(str_width(mixed) == expected, "mixed width", expected, str_width(mixed));
...
fn e2e_unicode_str_width_with_combining() {
    ...
    crate::assert_with_log!(str_width(e_acute) == 1, "e_acute width", 1usize, str_width(e_acute));

    // 'n' with combining tilde = width 1
    let n_tilde = "n\u{0303}";
    crate::assert_with_log!(str_width(n_tilde) == 1, "n_tilde width", 1usize, str_width(n_tilde));
...
fn e2e_unicode_str_width_fullwidth() {
    ...
    crate::assert_with_log!(char_width(fullwidth_a) == 2, "fullwidth A", 2usize, char_width(fullwidth_a));
...
fn e2e_unicode_boundary_characters() {
    ...
    crate::assert_with_log!(char_width(hangul_start) == 2, "hangul start", 2usize, char_width(hangul_start));
    crate::assert_with_log!(char_width(hangul_end) == 2, "hangul end", 2usize, char_width(hangul_end));
